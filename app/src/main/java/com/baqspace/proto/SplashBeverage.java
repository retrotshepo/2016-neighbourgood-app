...
public class SplashBeverage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_splash_beverage);
    ...
    private void startSplash()
    {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                System.out.println("Splashed Bev: " + session.getSession().getType());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //getMenuInflater().inflate(R.menu.menu_splash_beverage, menu);
        return true;
    }
