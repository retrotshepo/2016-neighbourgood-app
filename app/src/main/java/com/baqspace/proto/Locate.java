...
public class Locate extends FragmentActivity implements OnMapReadyCallback {
    ...
    double latitude = -26.1941301;
    double longitude = 28.0350528;
    //-26.1941301,28.0350528
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setUpMapIfNeeded();
        Toast.makeText(Locate.this, "Please tap on pin and open maps at the bottom of your screen",Toast.LENGTH_SHORT).show();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(ngm).title("Neighbourgoods Market"));
